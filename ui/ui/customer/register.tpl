...
<main class="container">
    ...
    <form enctype="multipart/form-data" action="{Text::url('register/post')}" method="post">
        ...
        <div class="main-grid">
            ...
            <section class="card">
                <h2 class="card-title">1. {Lang::T('Register as Member')}</h2>
                ...
                {if $_c['photo_register'] == 'yes'}
                    <div class="form-group">
                        <label class="label" for="photo">{Lang::T('Photo')}</label>
                        <input id="photo" name="photo" accept="image/*" type="file">
                    </div>
                {/if}

                <div class="form-group">
                    <label class="label" for="fullname">{Lang::T('Full Name')}</label>
                    <div class="input-wrapper">
                        <span class="input-icon">👤</span>
                        <input class="input-field" id="fullname" value="{$fullname}" name="fullname" 
                            {if $_c['man_fields_fname'] neq 'no'}required{/if} type="text">
                    </div>
                </div>

                <div class="form-group">
                    <label class="label" for="email">{Lang::T('Email')}</label>
                    <div class="input-wrapper">
                        <span class="input-icon">✉️</span>
                        <input class="input-field" id="email" placeholder="xxxxxxx@xxxx.xx" value="{$email}" name="email" 
                            {if $_c['man_fields_email'] neq 'no'}required{/if} type="text">
                    </div>
                </div>

                <div class="form-group">
                    <label class="label" for="address">{Lang::T('Home Address')}</label>
                    <div class="input-wrapper">
                        <span class="input-icon">🏠</span>
                        <input class="input-field" id="address" value="{$address}" name="address" 
                            {if $_c['man_fields_address'] neq 'no'}required{/if} type="text">
                    </div>
                </div>
            ...
            <!-- Password Panel -->
            <section class="card">
                <h2 class="card-title">2. {Lang::T('Password')}</h2>
                ...
                <div class="form-group">
                    <label class="label" for="cpassword">{Lang::T('Confirm Password')}</label>
                    <div class="input-wrapper">
                        <span class="input-icon">🔒</span>
                        <input class="input-field" id="cpassword" name="cpassword" required type="password">
                    </div>
                </div>

                <div class="button-row">
                    <a class="btn btn-outline" href="{Text::url('login')}">
                        <span>✕</span> {Lang::T('Cancel')}
                    </a>
